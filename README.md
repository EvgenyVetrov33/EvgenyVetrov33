...
<h2>👩‍💻 Обо мне</h2>
  <p>Мне нравится решать сложные задачи: разрабатывать сайты и веб-приложения или создавать дизайн сайтов с удобным интерфейсом.</p>
  <p>Меня захватывает процесс разработки и возможность создавать удобные и полезные продукты. Посмотрите мои работы сайте github https://github.com/EvgenyVetrov33 в разделе Портфолио.</p>
  <p>Ещё защитил диплом Веб-разработчика в Яндекс Практикуме. Есть рекомендация от лида команды. Ежедневно практикуюсь в программировании, пишу pet-проекты, изучаю алгоритмы и фреймворки (React, Wordpress).</p>
  <h2>👨‍🎓 Образование</h2>
  <div>
